...
void chassis_behaviour_mode_set(chassis_move_t *chassis_move_mode)
{
    ...
    mouse_trigger.press_r = chassis_move_mode->chassis_RC->mouse.press_r;
...
static void chassis_infantry_follow_gimbal_yaw_control(fp32 *vx_set, fp32 *vy_set, fp32 *angle_set, chassis_move_t *chassis_move_rc_to_vector)
{
    ...
    static fp32 const add_time = PI / 400.0f;
    //使能摇摆标志位
...
//    }
    ...
    {
        max_angle = SWING_MOVE_ANGLE*2.0f;
    }
    else
    {
        max_angle = SWING_NO_MOVE_ANGLE*2.0f;
    }
    //sin函数生成控制角度
    if (swing_flag)
    {
