...
////////////////////////////////////////////////////////////////////
//ARM 速度环 PID参数以及 PID最大输出，积分输出
#define ARM_SPEED_PID_KP 15000.0f
#define ARM_SPEED_PID_KI 10.0f
#define ARM_SPEED_PID_KD 0.0f
#define ARM_SPEED_PID_MAX_OUT 30000.0f//30000.0f
#define ARM_SPEED_PID_MAX_IOUT 2000.0f

//ARM 机械臂最大转速
#define ARM_MAX_SPEED 3.0f
//ARM 机械臂与遥控器输入比例
#define ARM_RC_SEN 0.001f
//ARM 机械臂与鼠标输入比例
#define ARM_MOUSE_SEN 0.00025f
//ARM 机械臂控制通道
#define Arm12Channel 3
#define Arm34Channel 2
///////////////////////////////////////////////////////////////////
//任务初始化 空闲一段时间
...
typedef struct
{
    ...
    PidTypeDef gimbal_motor_gyro_pid;
		...
		PidTypeDef gimbal_motor_rpm_pid;//
...
typedef struct
{
    ...
    const fp32 *gimbal_INT_gyro_point;
		Gimbal_Motor_t gimbal_arm1_motor;//机械臂电机1
		Gimbal_Motor_t gimbal_arm2_motor;//机械臂电机2
		Gimbal_Motor_t gimbal_arm3_motor;//机械臂电机3
		Gimbal_Motor_t gimbal_arm4_motor;//机械臂电机4
    Gimbal_Motor_t gimbal_yaw_motor;
    Gimbal_Motor_t gimbal_pitch_motor;
    Gimbal_Cali_t gimbal_cali;
} Gimbal_Control_t;

extern const Gimbal_Motor_t *get_arm1_motor_point(void);
extern const Gimbal_Motor_t *get_arm2_motor_point(void);
extern const Gimbal_Motor_t *get_arm3_motor_point(void);
extern const Gimbal_Motor_t *get_arm4_motor_point(void);
