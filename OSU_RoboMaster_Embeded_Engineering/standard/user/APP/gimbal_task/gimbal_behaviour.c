...
void gimbal_behaviour_mode_set(Gimbal_Control_t *gimbal_mode_set)
{
    ...
    {
        gimbal_mode_set->gimbal_arm1_motor.gimbal_motor_mode = GIMBAL_MOTOR_RAW;
        gimbal_mode_set->gimbal_arm2_motor.gimbal_motor_mode = GIMBAL_MOTOR_RAW;
    }
    else if (gimbal_behaviour == GIMBAL_INIT)
    {
        gimbal_mode_set->gimbal_arm1_motor.gimbal_motor_mode = GIMBAL_MOTOR_ENCODE;
        gimbal_mode_set->gimbal_arm2_motor.gimbal_motor_mode = GIMBAL_MOTOR_ENCODE;
    }
...
//    {
//        gimbal_mode_set->gimbal_arm1_motor.gimbal_motor_mode = GIMBAL_MOTOR_AIM;
//        gimbal_mode_set->gimbal_arm2_motor.gimbal_motor_mode = GIMBAL_MOTOR_AIM;			
//		}
		else if (gimbal_behaviour == GIMBAL_ABSOLUTE_ANGLE)
    {
        gimbal_mode_set->gimbal_arm1_motor.gimbal_motor_mode = GIMBAL_MOTOR_GYRO;
        gimbal_mode_set->gimbal_arm2_motor.gimbal_motor_mode = GIMBAL_MOTOR_GYRO;
    }
...
//        init_time++;
//        //到达中值 计时
//        if ((fabs(gimbal_mode_set->gimbal_arm1_motor.relative_angle - INIT_YAW_SET) < GIMBAL_INIT_ANGLE_ERROR &&
//             fabs(gimbal_mode_set->gimbal_arm2_motor.absolute_angle - INIT_PITCH_SET) < GIMBAL_INIT_ANGLE_ERROR))
//        {
//            //到达初始化位置
...
static void gimbal_init_control(fp32 *yaw, fp32 *pitch, Gimbal_Control_t *gimbal_control_set)
{
    ...
    //初始化状态控制量计算
    if (fabs(INIT_PITCH_SET - gimbal_control_set->gimbal_arm2_motor.absolute_angle) > GIMBAL_INIT_ANGLE_ERROR)
    {
        *pitch = (INIT_PITCH_SET - gimbal_control_set->gimbal_arm2_motor.absolute_angle) * GIMBAL_INIT_PITCH_SPEED;
        *yaw = 0.0f;
    }
    else
    {
        *pitch = (INIT_PITCH_SET - gimbal_control_set->gimbal_arm2_motor.absolute_angle) * GIMBAL_INIT_PITCH_SPEED;
        *yaw = (INIT_YAW_SET - gimbal_control_set->gimbal_arm1_motor.relative_angle) * GIMBAL_INIT_YAW_SPEED;
    }
}
...
//        //判断陀螺仪数据， 并记录最大最小角度数据
//        GIMBAL_CALI_GYRO_JUDGE(gimbal_control_set->gimbal_arm2_motor.motor_gyro, cali_time, gimbal_control_set->gimbal_cali.max_pitch,
//                               gimbal_control_set->gimbal_arm2_motor.absolute_angle, gimbal_control_set->gimbal_cali.max_pitch_ecd,
//                               gimbal_control_set->gimbal_arm2_motor.gimbal_motor_measure->ecd, gimbal_control_set->gimbal_cali.step);
//    }
...
//        GIMBAL_CALI_GYRO_JUDGE(gimbal_control_set->gimbal_arm2_motor.motor_gyro, cali_time, gimbal_control_set->gimbal_cali.min_pitch,
//                               gimbal_control_set->gimbal_arm2_motor.absolute_angle, gimbal_control_set->gimbal_cali.min_pitch_ecd,
//                               gimbal_control_set->gimbal_arm2_motor.gimbal_motor_measure->ecd, gimbal_control_set->gimbal_cali.step);
//    }
...
//        GIMBAL_CALI_GYRO_JUDGE(gimbal_control_set->gimbal_arm1_motor.motor_gyro, cali_time, gimbal_control_set->gimbal_cali.max_yaw,
//                               gimbal_control_set->gimbal_arm1_motor.absolute_angle, gimbal_control_set->gimbal_cali.max_yaw_ecd,
//                               gimbal_control_set->gimbal_arm1_motor.gimbal_motor_measure->ecd, gimbal_control_set->gimbal_cali.step);
//    }
...
//        GIMBAL_CALI_GYRO_JUDGE(gimbal_control_set->gimbal_arm1_motor.motor_gyro, cali_time, gimbal_control_set->gimbal_cali.min_yaw,
//                               gimbal_control_set->gimbal_arm1_motor.absolute_angle, gimbal_control_set->gimbal_cali.min_yaw_ecd,
//                               gimbal_control_set->gimbal_arm1_motor.gimbal_motor_measure->ecd, gimbal_control_set->gimbal_cali.step);
//    }
...
//                gimbal_turn_flag = 1;
//							//保存掉头的目标值
//                gimbal_end_angle = rad_format(gimbal_control_set->gimbal_arm1_motor.absolute_angle + PI);
//            }
//        }
...
//            if (rad_format(gimbal_end_angle - gimbal_control_set->gimbal_arm1_motor.absolute_angle) > 0.0f)
//            {
//                *yaw += TurnSpeed;
//							buzzer_on(140,10000);
//            }
...
//        }
//        //到达pi （180°）后停止
//        if (gimbal_turn_flag && fabs(rad_format(gimbal_end_angle - gimbal_control_set->gimbal_arm1_motor.absolute_angle)) < 0.01f)
//        {
//            gimbal_turn_flag = 0;
//					buzzer_off();
//        }
